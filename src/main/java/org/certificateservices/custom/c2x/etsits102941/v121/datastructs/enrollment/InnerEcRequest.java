...
public class InnerEcRequest extends COERSequence {
	 ...
	 */
	public InnerEcRequest(COERIA5String itsId, CertificateFormat certificateFormat, PublicKeys publicKeys, CertificateSubjectAttributes requestedSubjectAttributes){
		super(true,4);
		init();
	 ...
	 * @return itsId value
	 */
	public COERIA5String getItsId(){
		return (COERIA5String) get(ITSID);
	}
