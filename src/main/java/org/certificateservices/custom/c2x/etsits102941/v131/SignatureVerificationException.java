...
/**
 * Exception thrown if signature couldn't be verified of a ETSITS102941 Messages ca request.
 *
...
public class SignatureVerificationException extends ETSITS102941MessagesCaException {
     ...
     *                    if not applicable.
     */
    public SignatureVerificationException(String message, Throwable cause, SecretKey secretKey, byte[] requestHash) {
