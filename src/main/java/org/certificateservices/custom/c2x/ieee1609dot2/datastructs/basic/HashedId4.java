...
/**
 * This data structure contains the truncated hash of another data structure. The HashedId4 for a given data
 ...
 *
 */
public class HashedId4 extends HashedId {
	...
	/**
	 * Constructor used to create a hashedid4 value for a full hash byte array.
	 * @param fullHashValue the fill hash value.
	 * @throws IllegalArgumentException if full hash value was shorted that hash length
	 */
	public HashedId4(byte[] fullHashValue) throws IllegalArgumentException {
		super(fullHashValue);
	}
	...
	public String toString() {
		return "HashedId4 [" + new String(Hex.encode(data)) + "]";
	}
