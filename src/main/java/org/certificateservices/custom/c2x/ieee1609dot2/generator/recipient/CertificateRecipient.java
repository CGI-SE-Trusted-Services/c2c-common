...
public class CertificateRecipient extends BasePKRecipient{
	...
	public RecipientInfo toRecipientInfo(AlgorithmIndicator alg,
		...
		EncryptedDataEncryptionKey encKey = cryptoManager.eCEISEncryptSymmetricKey(getEncKeyType(pubEncKey.getPublicKey().getType()), certEncKey, encryptionKey, pubEncKey.getSupportedSymmAlg(), certHash);
