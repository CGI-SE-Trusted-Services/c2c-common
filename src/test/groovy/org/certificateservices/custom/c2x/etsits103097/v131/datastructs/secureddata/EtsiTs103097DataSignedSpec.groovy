...
class EtsiTs103097DataSignedSpec extends BaseStructSpec {
    ...
    def "Verify that constructor accepts valid signed data"(){
        ...
        when:
        def d2 = new EtsiTs103097DataSigned(Hex.decode(""))
        then:
    ...
    def "Verify that constructor throws IllegalArgumentException if data field is not set."(){
        when:
        new EtsiTs103097DataSigned(2, newSignedData(new Time64(10000L), new HashedData(HashedData.HashedDataChoices.sha256HashedData, Hex.decode("0102030405060708091011121314151617181920212223242526272829303132"))))
        then:
        def e = thrown(IllegalArgumentException)
    ...
    def "Verify that constructor throws IllegalArgumentException if data field is contains other than unencrypted"(){
        when:
        new EtsiTs103097DataSigned(2, newSignedData(new Time64(10000L), null, genEncryptedData()))
        then:
        def e = thrown(IllegalArgumentException)
    ...
    static Ieee1609Dot2Content newSignedData(Time64 generationTime=new Time64(10000L), HashedData externalHashData = null, Ieee1609Dot2Content signedContent = null){
