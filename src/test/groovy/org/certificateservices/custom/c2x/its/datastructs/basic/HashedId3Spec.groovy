 ...
 *
 */
class HashedId3Spec extends BaseStructSpec {
	
	
	def "Verify the correct octet length of the HashedId3"(){
		expect:
		new HashedId3().getHashLength() == 3
		
	}
	
	def "Verify toString"(){
		expect:
		 new HashedId3(Hex.decode("998877665544332222")).toString() == "HashedId3 [hashedId=[51, 34, 34]]"
	}
