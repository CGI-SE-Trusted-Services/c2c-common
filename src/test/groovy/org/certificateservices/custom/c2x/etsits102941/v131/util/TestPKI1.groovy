...
class TestPKI1 {
    ...
    EtsiTs102941CTL fullRootCA4Ctl
    EtsiTs102941CTL deltaRootCA1Ctl
    EtsiTs102941CTL deltaRootCA4Ctl
    EtsiTs102941CRL rootCA1Crl
    EtsiTs102941CRL rootCA4Crl
    ...
    EtsiTs103097Certificate rootca4
        ...
        TestPKI1(){
            ...
            rootca4 = BasePermissionValidatorSpec.genCert(
                    [type: "rootca",
                     name: "Test RootCA1",
                     region: [752],
                     startTime: "2019-08-01 14:01:02", duration: 24, durationUnit: "years",
            ...
            fullRootCA4Ctl = genCTL([ type: "rcactl",
                                      nextUpdate: "2020-02-10 10:10:10",
                                      sequence: 1,
                                      commands:[[
                                                        command: "add",
                                                        type: "dc",
                                                        url: "http://somedc",
                                                        certIds: [rootca4.asHashedId8(cryptoManager)]
            ...
            deltaRootCA4Ctl = genCTL([ type: "rcactl",
                                       nextUpdate: "2020-02-08 10:11:10",
                                       delta: true,
                                       sequence: 1,
                                       commands:[[
            ...
            rootCA4Crl = genCRL([thisUpdate : "2020-02-07 10:12:10",
                                 nextUpdate : "2020-03-07 10:11:10",
                                 entries    : [rca1_ea1, rca1_aa1],
                                 signerChain: [rootca4],
                                 signerKey  : rootCA1SigningKeys
