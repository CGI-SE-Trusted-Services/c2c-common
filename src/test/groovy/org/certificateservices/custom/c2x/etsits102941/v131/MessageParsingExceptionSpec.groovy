...
/**
 * Unit tests for MessageParsingException
 */
class MessageParsingExceptionSpec extends Specification {
    ...
    def "Verify that constructor populates fields correctly"(){
        ...
        when:
        def e1 = new MessageParsingException("SomeMessage", key)
        then:
        e1.message == "SomeMessage"
        e1.getSecretKey() == key

        when:
        def e2 = new MessageParsingException("SomeMessage", cause ,key, requestHash, receiver)
        then:
