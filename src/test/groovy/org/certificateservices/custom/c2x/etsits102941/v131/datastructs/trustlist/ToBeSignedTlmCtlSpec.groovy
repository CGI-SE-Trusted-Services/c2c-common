...
/**
 * Unit tests for ToBeSignedTlmCtl.
 *
 * @author Philip Vendil, p.vendil@cgi.com
 *
 */
class ToBeSignedTlmCtlSpec extends BaseStructSpec {
    ...
    def "Verify that constructor and getters are correct and it is correctly encoded"() {
        when:
        ToBeSignedTlmCtl f1 = new ToBeSignedTlmCtl(ver, nextUpdate, true, 12, ctlCommands)
        then:
        serializeToHex(f1) == ""
        when:
        ToBeSignedTlmCtl f2 = deserializeFromHex(new ToBeSignedTlmCtl(), "")
        then:
        f2.getVersion() == ver
    ...
    def "Verify toString()"() {
        expect:
        new ToBeSignedTlmCtl(ver, nextUpdate, true, 12, ctlCommands).toString() == """ToBeSignedTlmCtl [
  version=1
