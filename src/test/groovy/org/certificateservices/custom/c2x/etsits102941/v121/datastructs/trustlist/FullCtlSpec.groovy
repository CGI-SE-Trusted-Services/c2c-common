...
/**
 * Unit tests for FullCtl.
 *
 * @author Philip Vendil, p.vendil@cgi.com
 *
 */
class FullCtlSpec extends BaseStructSpec {
    ...
    def "Verify that constructor and getters are correct and it is correctly encoded"(){
        when:
        FullCtl f1 = new FullCtl(ver,nextUpdate,12,ctlCommands)
        then:
        ...
        when:
        CtlFormat f2 = deserializeFromHex(new CtlFormat(), "")
        then:
        f2.getVersion() == ver
    ...
    def "Verify toString()"() {
        expect:
        new FullCtl(ver, nextUpdate,  12, ctlCommands).toString() == """FullCtl [
  version=1
