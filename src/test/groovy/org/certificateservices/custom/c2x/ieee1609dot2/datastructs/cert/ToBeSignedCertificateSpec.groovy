...
class ToBeSignedCertificateSpec extends BaseStructSpec {
	...
	def "Verify that constructor and getters are correct and it is correctly encoded"(){
		...
		serializeToHex(c) == ""
		when:
		ToBeSignedCertificate c2 = deserializeFromHex(new ToBeSignedCertificate(), "")
		then:
		c2.getId() == id
		...
		then:
		serializeToHex(c3) == ""
		when:
		ToBeSignedCertificate c4 = deserializeFromHex(new ToBeSignedCertificate(), "")
		then:
		c4.getId() == id
