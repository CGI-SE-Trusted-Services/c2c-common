...
class HeaderInfoSpec extends BaseCertGeneratorSpec {
	...
	Time64 generationTime = new Time64(BigInteger.valueOf(5000000000L))
	Time64 expiryTime = new Time64(BigInteger.valueOf(6000000000L))
	...
	def "Verify that constructor and getters are correct and it is correctly encoded"(){
		...
		then:
		hi1.hasExtension
		serializeToHex(hi1) == ""
		when:
		HeaderInfo hi2 = deserializeFromHex(new HeaderInfo(), "")
		then:
		hi2.hasExtension
		hi2.getPsid() == psid
  ...
  psid=[64(40)],
  generationTime=[timeStamp=Thu Jan 01 02:23:20 CET 2004 (5000000000)],
  expiryTime=[timeStamp=Thu Jan 01 02:40:00 CET 2004 (6000000000)],
